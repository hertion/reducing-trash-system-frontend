...
Page({
  ...
  swichNav: function (e) {
    ...
    submit() {
      ...
      if (this.data.currentTab == 0) {
        var link = app.globalData.http + '/api/recycleFirm/list/CROrder/checking';
      ...
      if (this.data.currentTab == 1) {
        var link = app.globalData.http + '/api/recycleFirm/list/CROrder/checked';
        if (this.data.areaInfo != '' && this.data.showDate == '') {
          var data = {
            addressVo: {
              village: this.data.villages[value[2]].name
  ...
  onLoad: function (options) {
    var that = this;
    var link1 = app.globalData.http +'/api/recycleFirm/list/CROrder/checking';
    var link2 = app.globalData.http +'/api/recycleFirm/list/CROrder/checked';
