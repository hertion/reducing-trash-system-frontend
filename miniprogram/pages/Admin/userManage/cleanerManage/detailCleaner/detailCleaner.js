...
Page({
  ...
  gotoTransferCleaner(){
    ...
    wx.navigateTo({
      url: '../transferCleaner/transferCleaner?StringResults='+StringResults+'&id='+id,
    })
  },
  stopLogin(){
    var that = this;
    var Token = app.getToken();
    var link = app.globalData.http+'/api/admin/set/user/usable/'+this.data.id+'/false'
    wx.request({
      url: link,
      method:'POST',
      header: {
  ...
  onLoad: function (options) {
    ...
    var link =app.globalData.http+'/api/admin/get/farmer/byCleanerId?id='+id;
    var Token = app.getToken();
    wx.request({
      url: link,
      header: {
