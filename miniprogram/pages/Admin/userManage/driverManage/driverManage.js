...
Page({
  ...
  gotoAddCleaner(){
    wx.navigateTo({
      url: '../driverManage/addDriver/addDriver',
    })
  },
  gotoDetailCleaner(event){
    ...
    wx.navigateTo({
      url: 'detailDriver/detailDriver?id='+id+'&name='+name+'&phoneNumber='+phoneNumber+'&areaInfo='+areaInfo,
    })
  },
  /**
   * 生命周期函数--监听页面加载
  ...
  onLoad: function (options) {
    var that = this;
    var link  = app.globalData.http +'/api/admin/get/Driver';
