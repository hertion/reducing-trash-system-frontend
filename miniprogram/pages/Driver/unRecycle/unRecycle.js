// miniprogram/pages/unRecycle/unRecycle.js
var app = getApp()
Page({
   ...
   */
  submit() {
    app.globalData.cdOrder.garbageChooses = this.data.garbageChooses;
    app.globalData.cdOrder.score = this.data.score;
    app.globalData.updateFlag=1;
    wx.navigateTo({
      url: '../driverOrderDetail/driverOrderDetail?id='+this.data.orderId,
    })
  },
  /**
   * 导航所用方法（黑盒）
  ...
  onLoad: function (options) {
    this.setData({
      ...
      garbageChooses: app.globalData.cdOrder.garbageChooses,
      score:app.globalData.cdOrder.score,
