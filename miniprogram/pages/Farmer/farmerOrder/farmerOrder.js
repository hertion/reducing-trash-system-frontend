...
Page({
  ...
  submit() {
    ...
    if (this.data.currentTab == 1) {
      var link = app.globalData.http + '/api/farmer/getFCOrder/checked';
      if (this.data.areaInfo != '' && this.data.showDate == '') {
        var data = {
          addressVo: {
            village: this.data.villages[value[2]].name
  ...
  gotoOrderDetail(event) {
    ...
    console.log(id);
    wx.navigateTo({
      url: '../farmerOrderDetail/farmerOrderDetail?id=' + id,
    })
  },
  // 滑动切换tab
  ...
  onLoad: function (options) {
    var that = this;
    var link1 = app.globalData.http +'/api/farmer/getFCOrder/checking';
    var link2 = app.globalData.http + '/api/farmer/getFCOrder/checked';
